...
export const DetailsPage=()=>{
    ...
    useEffect((id)=>{
        ...
        // // if(param.get("id")!==null){                 //param index (selected index) !=empty strng
        //     let b = state.arr.filter((v,i)=>{
        //         return id ===Number(param.get(id))
        //     });
        //     // console.log(x)
        //     // let y= x.find((val,i)=>{
        //     //     return i===Number(param.get("id"))      // param la get pannathu string ah kidaikum atha number ah mathanum na Number use pannanum
        //     // })
        // // }
        setDet(b);
    },[det])
    ...
    const fav =(id)=>{
      ...
      const sub = (id) => {
        ...
        dispatch({ type: "sub", payload: updatedArr });
      };
